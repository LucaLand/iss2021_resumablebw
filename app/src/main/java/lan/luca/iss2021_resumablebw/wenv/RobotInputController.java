...
===============================================================
*/
package lan.luca.iss2021_resumablebw.wenv;
...
public class RobotInputController implements IssObserver {
    private final lan.luca.iss2021_resumablebw.wenv.RobotBoundaryLogic robotBehaviorLogic;
    ...
    public RobotInputController(IssCommSupport support, boolean usearil, boolean doMap) {
        commSupport = support;
        robotBehaviorLogic = new lan.luca.iss2021_resumablebw.wenv.RobotBoundaryLogic(support, usearil, doMap);
    }
