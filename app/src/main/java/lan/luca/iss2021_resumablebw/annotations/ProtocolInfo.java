    ...
    public ProtocolInfo(String protocolName, String url) {
        ...
        switch (protocolName) {
            ...
            case "WS":
                ...
                break;
            case "UDP":
                protocol = IssProtocolSpec.issProtocol.UDP;
                break;
            case "TCP":
                protocol = IssProtocolSpec.issProtocol.TCP;
                break;
            case "MQTT":
                protocol = IssProtocolSpec.issProtocol.MQTT;
                break;
            case "COAP":
                protocol = IssProtocolSpec.issProtocol.COAP;
                break;
            default:
                protocol = null;
        }
